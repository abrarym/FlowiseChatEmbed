...
export const Bot = (props: BotProps & { class?: string }) => {
    ...
    createEffect(async () => {
        const chatMessage = localStorage.getItem(
            `${props.chatflowid}_EXTERNAL`
        );
        if (chatMessage) {
                ...
                <div class="flex w-full h-full justify-center">
                                ...
                                <>
                                    {message.type === 'userMessage' && (
                                        <GuestBubble
                                            ...
                                            textColor={
                                                props.userMessage?.textColor
                                            }
                                            showAvatar={
                                                props.userMessage?.showAvatar
                                            }
                                            avatarSrc={
                                                props.userMessage?.avatarSrc
                                            }
                                        />
                                    )}
                                    {message.type === 'apiMessage' && (
                                        <BotBubble
                                            ...
                                            textColor={
                                                props.botMessage?.textColor
                                            }
                                            showAvatar={
                                                props.botMessage?.showAvatar
                                            }
                                            avatarSrc={
                    ...
                    <div
                        style={{
                            ...
                            'border-top-left-radius': props.isFullPage
                                ? '0px'
                                : '6px',
                            'border-top-right-radius': props.isFullPage
                                ? '0px'
                                : '6px',
                        }}
                    >
                        <Show when={props.titleAvatarSrc}>
                            <>
                                ...
                                <Avatar
                                    initialAvatarSrc={props.titleAvatarSrc}
                                />
                            </>
                        </Show>
